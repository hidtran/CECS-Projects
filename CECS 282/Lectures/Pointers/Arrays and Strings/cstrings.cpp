...
int main(int argc, char* argv[]) {
   ...
   */
   ...
   //Null terminator will trigger the end ofthe cout printing
...
<<<<<<< HEAD
		  //null terminator got replaced by '?'

=======
   cout << cStr << endl;
>>>>>>> cd490b5eb4fe682ee58144f440852181780a574e
   ...
   cin >> cStr; // compiles OK... but how many chars can cStr actually store?
                // does cin know that? cin add null terminator automatically
