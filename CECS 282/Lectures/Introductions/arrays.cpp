...
int main(int argc, char* argv[]) {
   ...
   int size;
   cin >> size;
//   int badArray[size]; // error: expression must have a constant value. ** Size of array can't be dynamic **

   // arrays are 0-based for indices
   myArray[0] = 100;

   // ** arrays are NOT BOUNDS-CHECKED **
   //results[12] = 500; // result of this is not defined; anything could happen! May have overwritten the jump function.
   ...
   */
   ...
   int grid[3][3] = {  // a 3x3 grid, grid[row][column]
