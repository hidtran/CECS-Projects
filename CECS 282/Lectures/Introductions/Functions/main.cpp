...
//Must declare functions as a prototype function of mymath.cpp to use it.
// ex: int Pow(int, int);
// or use #include "mymath.h" to correct the errors.
...
int main(int argc, char* argv[]) {
   ...
   int p = Pow(a, b); // error C3861: 'Pow': identifier not found **See above for errors correction
   int a = Average(a, b);
   ...
   // Finally, use the Ln function
   cout << Ln(10) << endl;
}

// SUMMARY:
// -- declaration vs definition.
// -- fuction prototypes / headers / signatures
// -- .h vs .cpp files.
