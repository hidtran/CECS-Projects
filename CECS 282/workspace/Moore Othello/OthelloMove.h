...
private:
   ...
   */
   ...
   /*
   Adds a FlipSet to the move's vector of sets. Used to keep track of how
   many enemy pieces were flipped in each direction when this move was
   applied. This function is private, but OthelloBoard has friend access.
   */
...
public:
   ...
   */
   ...
   static void operator delete(void* ptr, std::size_t sz) {
    mOnHeap--;
    std::cout << "operator delete: " << mOnHeap;
    std::cout << " OthelloMoves on the heap" << std::endl;
    ::operator delete(ptr);
   }
};

#endif /* OTHELLOMOVE_H_ */
