...
Othello. This includes the state of the board, tracking the current
...
public:
   ...
   */
   ...
   the current player. The moves should be ordered based first on row, then
   on column. Example ordering: (0, 5) (0, 7) (1, 0) (2, 0) (2, 2) (7, 7)
   ...
   */
   ...
   was in prior to the most recent move (including whose turn it is,
   ...
   */
   ...
   move in the vector is the most recent move applied to the board. You
   cannot modify or delete any of the pointers in this vector; they belong
   to the board. (A const vector does not allow modification of the objects
   returned by iterators. You may need to look up the const_iterator and
