...
/*
A ConnectFourBoard encapsulates data needed to represent a single game of ConnectFour.
...
public:
   ...
   */
   ...
   /*
   Creates a ConnectFourMove object on the heap. Whoever calls this method is
   ...
   */
   ...
   this should be "Yellow" or "Red", but this can be customized, e.g. for
   Connect Four.
   */
